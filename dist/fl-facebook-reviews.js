...
var ExpansibleTextBox = function () {
  function ExpansibleTextBox(text, maxCharacters, modulePrefix) {
    ...
    var cssPrefix = modulePrefix + '_' + CLASS_PREFIX;
 ...
 * @return {HTMLElement}
 */
function fillTemplate(review, modulePrefix) {
  ...
  var reviewTextBox = new ExpansibleTextBox(reviewText, maxCharacters, modulePrefix);
